  ...
  return (
    <Randomitemdiv>
      <img
        ...
        alt="" onClick={imgonclick} style={{cursor:'pointer'}}
      />
      <NavLink to={`/chart/${i.rank}/${listname}`}> <h3 style={{color:'white'}} >{i.name}</h3> </NavLink>
      <NavLink to={`/chart/${listname}/${i.artist}/${`artist`}`}><h4>{i.artist}</h4>
      </NavLink>
    </Randomitemdiv>
  );
});
